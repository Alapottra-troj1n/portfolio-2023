    ...
    >
      <div className="pt-20">
        ...
        <div
          ...
          className="flex flex-col gap-10 mt-10 bg-white text-dark lg:bg-dark lg:text-white lg:hover:bg-white lg:hover:text-dark transition"
        >
          <div className="border p-8 lg:p-20">
        ...
        <div className="flex flex-col gap-10 mt-10 bg-orange text-white lg:bg-dark lg:text-white lg:hover:bg-orange lg:hover:text-white transition">
          <div className="border border-orange lg:border-white p-8 lg:p-20">
            <div className="flex flex-col items-center">
              <h2 className="font-display text-center text-[2.3rem]  lg:text-[4rem] xl:text-[6rem] 2xl:text-[10rem]">
                GEEK HIVE
              </h2>
        ...
        <div
          onMouseEnter={() => cursorChange("40, 41, 31")}
          onMouseLeave={() => cursorChange("207, 237, 113")}
          className="flex flex-col gap-10 mt-10 bg-primary text-dark lg:bg-dark lg:text-white lg:hover:bg-primary lg:hover:text-dark transition"
        >
          <div className="border border-primary lg:border-white p-8 lg:p-20">
            <div className="flex flex-col items-center">
              <h2 className="font-display text-center text-[2.3rem]  lg:text-[4rem] xl:text-[6rem] 2xl:text-[10rem]">
                IGNITION
              </h2>
